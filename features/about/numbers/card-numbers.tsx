  ...
  return (
    <>
      <div className="group/card-numbers xs:aspect-3/4 xs:h-auto relative flex aspect-auto h-30 max-h-[220px] w-full flex-col items-center justify-center md:aspect-4/3">
        ...
        <div className="ease-power4-in-out flex h-15 w-14 scale-120 items-center justify-center object-contain opacity-60 transition-[opacity,scale] duration-800 group-hover/card-numbers:scale-90 group-hover/card-numbers:opacity-100">
