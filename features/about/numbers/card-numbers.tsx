  ...
  return (
    <>
      <div className="group/card-numbers xs:aspect-3/4 xs:h-auto relative flex aspect-auto h-30 max-h-[220px] w-full flex-col items-center justify-center md:aspect-4/3">
        ...
        <div
          className={clsx(
            'ease-power4-in-out flex h-15 w-14 items-center justify-center object-contain opacity-60',
            !isTouch &&
              'ease-power4-in-out scale-120 transition-[opacity,scale] duration-800 group-hover/card-numbers:scale-90 group-hover/card-numbers:opacity-100',
          )}
        >
          ...
          <p
            className={clsx(
              ...
              isTouch
                ...
                : 'ease-power4-in-out translate-y-5 transition-transform duration-800 group-hover/card-numbers:translate-y-0',
            )}
          >
            {name}
          </p>
